...
public class SubwayMapTest {
    ...
    @Test
    @DisplayName("Test Mouse Initalization")
    public  void testMouse() {
        ...
        Mouse mouse = new Mouse(true, subwayMap, false, 10,0,0,0,50);
        while (mouse.getDistance() < mouse.getMinDistance()) {
            System.out.printf("Current Position : %d Entrance : %d", mouse.getCurrentPos(), mouse.getCurrentPos());
            mouse.calculateNextMove();
            System.out.printf("Exit : %d New Mouse Position : %d and distance %d \n", mouse.getNextExit(), mouse.getCurrentPos(), mouse.getDistance());
        }
    }
}
